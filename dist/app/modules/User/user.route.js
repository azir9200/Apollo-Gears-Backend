...
router.post('/', (0, auth_1.default)(user_utils_1.USER_ROLE.admin), (0, validateRequest_1.default)(user_validation_1.createUserValidationSchema), user_controller_1.UserController.createUser);
router.get('/', (0, auth_1.default)(user_utils_1.USER_ROLE.admin), user_controller_1.UserController.getAllUsers);
router.get('/:id', (0, auth_1.default)(user_utils_1.USER_ROLE.admin, user_utils_1.USER_ROLE.driver, user_utils_1.USER_ROLE.user), user_controller_1.UserController.findUserById);
